 ...
 *
 * @param <P>  the type of the parameters that implements BaseQueryRepository.Params
 ...
 */
public interface Param2ParamsMethod<P extends BaseQueryRepository.Params, V1, V2> {
